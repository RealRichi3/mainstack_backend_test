...
export class AuthCache {
    ...
    private static async compareData({
        tokenType,
        user,
        dataToCompare,
    }: {
...
class AuthorizationUtil {
    static async generateToken({
        ...
        const dataToEmbedInToken: TokenPayload = {
    ...
    static async generateCode({
        ...
        const dataToEmbedInCode: TokenPayload = {
            user: { ...plainUserObject, profile: userProfile },
            tokenType: codeType,
            expiryDate,
        };
    ...
    static async clearAuthorization({
        tokenType,
        user,
    }: {
        tokenType: AuthType;
